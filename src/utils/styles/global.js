...
export default createGlobalStyle`
    ...
    *::after {
    ...
    body {
      ...
      height: 100%;
      overflow: visible;
      --primary: ${props => props.theme.primaryMain};
      --primary-light: ${props => props.theme.primaryLight};
      --primary-lighter: ${props => props.theme.primaryLighter};
      --secondary: ${props => props.theme.secondaryMain};
      --secondary-light: ${props => props.theme.secondaryLight};
      --secondary-lighter: ${props => props.theme.secondaryLighter};
